...
import FINAL_EXAM.exceptions.NonexistentEntityException;
import FINAL_EXAM.exceptions.PreexistingEntityException;
...
public class SuratJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("FINAL_EXAM_demo_jar_0.0.1-SNAPSHOTPU");
